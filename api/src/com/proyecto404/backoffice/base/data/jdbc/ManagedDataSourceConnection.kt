...
class ManagedDataSourceConnection(private val datasource: com.proyecto404.backoffice.base.data.jdbc.DataSource, private val connection: Connection): Connection {
    override fun close() {
